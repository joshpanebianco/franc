...
Job.destroy_all
job1 = Job.create(title: 'General Assembly', description: 'A cool place to work', location: 'Sydney', requirements: 'Web Development', remuneration: '$50,000', position: 'Junior Web Developer', contract: 'Full-Time' )
job2 = Job.create(title: 'Pied Piper', description: 'A video compression company', location: 'Silicon Valley', requirements: 'Javascript, React', remuneration: '$75,000', position: 'Javascript Developer', contract: 'Part-Time')
job3 = Job.create(title: 'Ansarada', description: 'If you love SQL, you will love us', location: 'The Rocks', requirements: 'Web Development', remuneration: '$50,000', position: 'Ruby on Rails Developer', contract: 'Casual')
